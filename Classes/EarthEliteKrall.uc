class EarthEliteKrall extends DCEliteKrall;
...
{
	MyAmmo.ProjectileClass=class'EarthEliteKrallProjectile';
...
defaultproperties
{
     AmmunitionClass=Class'DEKMonsters999X.EarthEliteKrallAmmo'
     GibGroupClass=Class'DEKMonsters999X.EarthGibGroup'
     Skins(0)=Shader'DEKMonstersTexturesMaster208.EarthMonsters.EliteKrall_Earth-Shader'
     Skins(1)=Shader'DEKMonstersTexturesMaster208.EarthMonsters.EliteKrall_Earth-Shader'
}
