class NecroEnergyParticle extends UntargetedSeekerProjectile;
...
simulated function PostBeginPlay()
{
	...
	RealSmokeTrail = Spawn(class'NecroEnergyParticleFX',self);
	Dir = vector(Rotation);
	Velocity = speed * Dir;
...
simulated function Timer()
{
	...
	//local NecroEnergyChargeEmitter Charge;
	...
	if (Seeking != None)
	{
		...
		if(SeekingDistance < 50)
		{
			...
			//Charge = Spawn(class'NecroEnergyChargeEmitter',,,Seeking.Location);
