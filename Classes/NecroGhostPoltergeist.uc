...
{
	if (rand(99) >= 33)
		Self.PlaySound(sound'DEKMonsters208AA.MonsterSounds.NecroGhostDeathSound1',,500.00);
	else if (rand(99) >= 66)
		Self.PlaySound(sound'DEKMonsters208AA.MonsterSounds.NecroGhostDeathSound2',,500.00);
	else
		Self.PlaySound(sound'DEKMonsters208AA.MonsterSounds.NecroGhostDeathSound3',,500.00);
...
defaultproperties
{
     ...
     bMeleeFighter=False
     DeathSound(0)=Sound'DEKMonsters208AA.MonsterSounds.NecroGhostDeathSound1'
     DeathSound(1)=Sound'DEKMonsters208AA.MonsterSounds.NecroGhostDeathSound2'
     ScoringValue=10
     GibGroupClass=Class'DEKMonsters208AA.NecroGhostExpGibGroup'
     ...
     Skins(0)=FinalBlend'DEKRPGTexturesMaster208K.fX.SphereDamageFB'
     Skins(1)=FinalBlend'DEKRPGTexturesMaster208K.fX.SphereDamageFB'
