...
simulated function SpawnEffects(vector HitLocation, vector HitNormal)
{
    ...
    if (EffectIsRelevant(Location, false))
	{
		...
		Spawn(class'DEKMonsters208AH.EarthDebrisExplosion', Self,, HitLocation, rotator(-HitNormal));
    }
}
...
defaultproperties
{
     ChildProjectileClass=Class'DEKMonsters208AH.EarthTitanProjectileChild'
     ...
     MyDamageType=Class'DEKRPG208AH.DamTypeHellfireSentinel'
