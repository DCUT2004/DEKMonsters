...
function SpawnBelch()
{
	...
	if ( (numChildren >= MaxChildren) || (FRand() > 0.2) ||(DrawScale==1) )
	{
		if ( Controller != None )
		{
			...
			Spawn(class'DEKMonsters999X.EarthGiantGasbagBelch',,,FireStart,Controller.AdjustAim(SavedFireProperties,FireStart,600));
...
defaultproperties
{
     AmmunitionClass=Class'DEKMonsters999X.EarthGiantGasbagAmmo'
