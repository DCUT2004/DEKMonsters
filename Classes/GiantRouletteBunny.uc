...
{	
	...
	if (bXPForm)
	{
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AE.GemExperiencePickupBlue', None, 1);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AE.GemExperiencePickupGreen', None, 2);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AE.GemExperiencePickupPurple', None, 3);
			Damage *= 0;
