...
{	
	...
	if (bXPForm)
	{
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG209D.GemExperiencePickupBlue', None, 1);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG209D.GemExperiencePickupGreen', None, 2);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG209D.GemExperiencePickupPurple', None, 3);
			Damage *= 0;
