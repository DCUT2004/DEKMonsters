...
{	
	...
	if (bXPForm)
	{
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AG.GemExperiencePickupBlue', None, 1);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AG.GemExperiencePickupGreen', None, 2);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AG.GemExperiencePickupPurple', None, 3);
			Damage *= 0;
