...
{	
	...
	if (bXPForm)
	{
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG209B.GemExperiencePickupBlue', None, 1);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG209B.GemExperiencePickupGreen', None, 2);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG209B.GemExperiencePickupPurple', None, 3);
			Damage *= 0;
