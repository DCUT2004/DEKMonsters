...
{	
	...
	if (bXPForm)
	{
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AF.GemExperiencePickupBlue', None, 1);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AF.GemExperiencePickupGreen', None, 2);
			Damage *= 0;
		...
		{
			DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AF.GemExperiencePickupPurple', None, 3);
			Damage *= 0;
