...
defaultproperties
{
     ...
     SuckDamageType=Class'DEKMonsters208AG.DamTypeSoulWraith'
     AChannel=255
     DeathAnim(0)="Dead"
     DeathAnim(1)="Dead2"
     DeathAnim(2)="Dead3"
     ...
     Skins(0)=FinalBlend'DEKMonstersTexturesMaster208.NecroMonsters.WraithNaliFinalBlend'
     Skins(1)=FinalBlend'DEKMonstersTexturesMaster208.NecroMonsters.WraithNaliFinalBlend'
}
