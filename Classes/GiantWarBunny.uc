...
function TakeDamage( int Damage, Pawn instigatedBy, Vector hitlocation, vector momentum, class<DamageType> damageType)
{
	...
	if (instigatedBy != None && instigatedBy.Controller != None)
	{
		...
		DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208AA.GemExperiencePickupGold', None, NumGemDrop);
...
defaultproperties
{
     ...
     ChargerClass=Class'DEKMonsters208AA.BunnyGhostUltimaCharger'
     NumGemDrop=2
     Footstep(0)=None
     Footstep(1)=None
