...
defaultproperties
{
     ...
     SecHitEmitterClass=Class'DEKMonsters209F.BlueBoltChild'
     ...
     DamageType=Class'DEKMonsters209F.DamTypeIceSkaarjSniper'
     DamageTypeHeadShot=Class'DEKMonsters209F.DamTypeIceSkaarjSniperHeadShot'
}
