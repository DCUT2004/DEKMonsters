...
defaultproperties
{
     ...
     SecHitEmitterClass=Class'DEKMonsters208AA.BlueBoltChild'
     ...
     DamageType=Class'DEKMonsters208AA.DamTypeIceSkaarjSniper'
     DamageTypeHeadShot=Class'DEKMonsters208AA.DamTypeIceSkaarjSniperHeadShot'
}
