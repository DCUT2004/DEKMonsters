...
defaultproperties
{
     ...
     SecHitEmitterClass=Class'DEKMonsters208AC.BlueBoltChild'
     ...
     DamageType=Class'DEKMonsters208AC.DamTypeIceSkaarjSniper'
     DamageTypeHeadShot=Class'DEKMonsters208AC.DamTypeIceSkaarjSniperHeadShot'
}
