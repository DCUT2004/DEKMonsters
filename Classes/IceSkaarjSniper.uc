...
defaultproperties
{
     ...
     SecHitEmitterClass=Class'DEKMonsters208AG.BlueBoltChild'
     ...
     DamageType=Class'DEKMonsters208AG.DamTypeIceSkaarjSniper'
     DamageTypeHeadShot=Class'DEKMonsters208AG.DamTypeIceSkaarjSniperHeadShot'
}
