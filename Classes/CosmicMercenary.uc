...
simulated function SprayTarget()
{
	...
	if ( Controller != None )
	{
		...
		PlaySound(Sound'DEKMonsters208AA.MonsterSounds.PlasmaTurretFire');
	}
}
...
defaultproperties
{
     RocketAmmoClass=Class'DEKMonsters208AA.CosmicMercenaryAmmo'
     AmmunitionClass=Class'DEKMonsters208AA.CosmicMercenaryAmmo'
     ScoringValue=10
